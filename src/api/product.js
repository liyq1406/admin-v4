module.exports = function (Vue, Promise, config) {
  return {
    ...
    getProductKey: function (product_id) {
      return new Promise(function (resolve, reject) {
        Vue.http.get(
          config.apiRoot + '/product/' + product_id + '/key',
          function (data, status, request) {
            resolve(data);
          }, {
            headers: {
    ...
    addFirmware: function (product_id, params) {
      return new Promise(function (resolve, reject) {
        Vue.http.post(
          config.apiRoot + '/product/' + product_id + '/firmware',
          JSON.stringify(params),
          function (data, status, request) {
            resolve(data);
          }, {
    ...
    updateFirmware: function (product_id, firmware) {
      return new Promise(function (resolve, reject) {
        ...
        Vue.http.put(
          config.apiRoot + '/product/' + product_id + '/firmware/' + firmware.id,
          JSON.stringify(params),
          function (data, status, request) {
            resolve(data);
          }, {
    ...
    deleteFirmware: function (product_id, firmware_id) {
      return new Promise(function (resolve, reject) {
        Vue.http.delete(
          config.apiRoot + '/product/' + product_id + '/firmware/' + firmware_id,
          function (data, status, request) {
            resolve(data);
          }, {
            headers: {
    ...
    getFirmwares: function (product_id) {
      return new Promise(function (resolve, reject) {
        Vue.http.get(
          config.apiRoot + '/product/' + product_id + '/firmwares',
          function (data, status, request) {
            resolve(data);
          }, {
            headers: {
    ...
    addDataPoint: function (product_id, params) {
      return new Promise(function (resolve, reject) {
        Vue.http.post(
          config.apiRoot + '/product/' + product_id + '/datapoint',
          JSON.stringify(params),
          function (data, status, request) {
            resolve(data);
          }, {
    ...
    updateDataPoint: function (product_id, datapoint) {
      return new Promise(function (resolve, reject) {
        ...
        Vue.http.put(
          config.apiRoot + '/product/' + product_id + '/datapoint/' + datapoint.id,
          JSON.stringify(params),
          function (data, status, request) {
            resolve(data);
          }, {
    ...
    deleteDataPoint: function (product_id, datapoint_id) {
      return new Promise(function (resolve, reject) {
        Vue.http.delete(
          config.apiRoot + '/product/' + product_id + '/datapoint/' + datapoint_id,
          function (data, status, request) {
            resolve(data);
          }, {
            headers: {
    ...
    getDatapoints: function (product_id) {
      return new Promise(function (resolve, reject) {
        Vue.http.get(
          config.apiRoot + '/product/' + product_id + '/datapoints',
          function (data, status, request) {
            resolve(data);
          }, {
            headers: {
