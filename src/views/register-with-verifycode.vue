      ...
      <div class="form-body">
        ...
        <div class="form-row row-group">
          <div class="form-row row">
            ...
            <div v-if="validation.$submitted && validation.email.$pristine" class="form-tips form-tips-error"><span v-if="validation.email.$error.required">{{ $t('common.validation.required', {field: $t('auth.fields.email')}) }}</span></div>
            <div v-if="validation.email.$dirty" class="form-tips form-tips-error"><span v-if="validation.email.$error.required">{{ $t('common.validation.required', {field: $t('auth.fields.email')}) }}</span><span v-if="validation.email.$error.email">{{ $t('common.validation.format', {field: $t('auth.fields.email')}) }}</span></div>
          </div>
          <div class="form-row row">
        ...
        <div class="form-row row-group">
          ...
          <div class="form-row row">
            ...
            <div v-if="validation.$submitted && validation.company.$pristine" class="form-tips form-tips-error"><span v-if="validation.company.$error.required">{{ $t('common.validation.required', {field: $t('auth.fields.company')}) }}</span></div>
            <div v-if="validation.company.$dirty" class="form-tips form-tips-error"><span v-if="validation.company.$error.required">{{ $t('common.validation.required', {field: $t('auth.fields.company')}) }}</span><span v-if="validation.company.$error.maxlength">{{ $t('common.validation.maxlength', [ $t('auth.fields.company'), 32]) }}</span></div>
          </div>
          <div class="form-row row">
            <div class="select">
