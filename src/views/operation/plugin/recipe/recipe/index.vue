    ...
    <div class="panel">
      <div class="panel-bd">
        <div class="action-bar">
          <search-box :key.sync="query" :active="searching" :placeholder="$t('ui.ingredient.placeholders.search_condi')" @cancel="getRecipes" @search-activate="toggleSearching" @search-deactivate="toggleSearching" @search="handleSearch" @press-enter="getRecipes">
            <button slot="search-button" @click="getRecipes" class="btn btn-primary"><i class="fa fa-search"></i></button>
          </search-box>
        ...
        <pager v-if="total > countPerPage" :total="total" :current.sync="currentPage" :count-per-page="countPerPage" @page-update="getRecipes"></pager>
      </div>
    </div>
    <!-- 类别管理浮层-->
