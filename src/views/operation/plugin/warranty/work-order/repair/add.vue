              ...
              <div class="form-row row">
                ...
                <div class="controls col-19">
                  <div v-placeholder="'请输入维修说明'" class="input-text-wrap">
                    <textarea v-lengthtip="{max: 240, model:addModal.discription }" v-model="addModal.remark" type="text" v-form-ctrl name="remark" minlength="2" maxlength="32" lazy required class="input-text"></textarea>
                  </div>
