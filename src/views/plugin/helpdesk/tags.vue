        ...
        <div class="data-table with-loading">
          ...
          <table class="table table-stripe table-bordered">
            ...
            <tbody>
              ...
              <tr v-if="tags.length === 0 && !loadingData">
      ...
      <div slot="body" class="form">
        <form v-form name="editValidation" @submit.prevent="onEditSubmit" hook="editFormHook">
          <div class="form-row row">
            ...
            <div class="controls col-18">
              <div class="input-text-wrap">
                <input v-model="editModel.name" type="text" v-form-ctrl name="name" required lazy class="input-text"/>
              </div>
  ...
  export default {
    ...
    methods: {
      ...
      onAddSubmit () {
        ...
        //   this.adding = true
        //   api.issue.addTag(this.addModel).then((res) => {
        //     if (res.status === 200) {
        //       this.resetAdd()
        //       this.getIssues()
        //     }
      ...
      onEditSubmit () {
        ...
        //   this.editing = true
        //   api.issue.deleteTag(this.editModel.id).then((res) => {
        //     if (res.status === 200) {
        //       this.resetEdit()
        //       this.delChecked = false
        //       this.getTags()
        ...
        //   this.editing = true
        //   api.issue.updateTag(this.editModel).then((res) => {
        //     if (res.status === 200) {
        //       this.resetEdit()
        //       this.tags.$set(this.editIndex, res.data)
        //     }
        //   }).catch((res) => {
        //     this.handleError(res)
        //     this.editing = false
