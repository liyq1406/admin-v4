          ...
          <div class="panel-bd">
            ...
            <ul v-else="v-else" class="user-details">
              ...
              <li>
                ...
                <div class="info"><span v-if="member.is_notice" class="hl-green">{{ $t("common.yes") }}</span><span v-else="v-else" class="hl-red">{{ $t("common.no") }}</span></div>
              </li>
              <li>
                <div class="label">{{ $t("member.fields.is_alert") }}:</div>
                <div class="info"><span v-if="member.is_alert" class="hl-green">{{ $t("common.yes") }}</span><span v-else="v-else" class="hl-red">{{ $t("common.no") }}</span></div>
              </li>
            </ul>
          </div>
        </div>
